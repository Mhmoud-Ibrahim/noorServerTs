...
export const addExpense = catchError(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const expense = new ExpenseModel({
        ...
        user: (req as any).user.userId // المعرف القادم من التوكن (الميدل وير)
    });
...
export const getAllExpenses = catchError(async (req: Request, res: Response, next: NextFunction) => {
