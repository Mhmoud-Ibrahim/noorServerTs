...
categoryRouter
    .post('/category', uploadMixOfFiles(mixFields, 'products'), authenticate, allowedTo('admin'), addCategory)
    .get('/category', getAllCategories)
    .get('/category/:id', getOneCategory)
    .delete('/category/:id', deleteCategory)
    .put('/category/:id', uploadSingleFile('imageCover', 'category'), authenticate, allowedTo('admin'), updateCategory);
